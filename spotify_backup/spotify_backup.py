...
def main():
	...
	parser.add_argument('--scope', default='playlist-read-collaborative, playlist-read-private', choices=['playlist-read-private', 'playlist-read-collaborative'], help='Spotify Scope to use, to get private or private and collaborative lists.  (default: playlist-read-collaborative)')
	...
	# Backup last run and extract the previos update time
	if path.exists(args.file):
		copyfile(f'./{args.file}', f'./last_{args.file}')
